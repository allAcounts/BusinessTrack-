...
const HomePageContent = ({ setShouldRenderLogin, setShouldRenderRegister }) =>
  <>
    ...
    <div className='buttons-container'>
      <Button btnLabel={'sign up'} btnCallback={() => setShouldRenderRegister(true)} btnClass='home-page-btn' />
      <Button btnLabel={'log in'} btnCallback={() => setShouldRenderLogin(true)} btnClass='home-page-btn' />
    </div>
